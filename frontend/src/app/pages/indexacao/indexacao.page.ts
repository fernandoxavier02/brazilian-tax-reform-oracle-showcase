...
export class IndexacaoPage {
  ...
  readonly pipeline = [
    { name: '1. Crawling', detail: '6/6 fontes' },
    { name: '2. Parsing', detail: '48.732 docs' },
    { name: '3. Chunking', detail: '312.846 chunks' },
    { name: '4. Embedding', detail: '312.846 vetores' },
    { name: '5. Validação', detail: '98,7% sucesso' },
    { name: '6. Indexação FAISS', detail: 'Hoje 06:12' },
  ];
